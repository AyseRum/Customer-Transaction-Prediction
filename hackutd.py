...
Original file is located at
    https://colab.research.google.com/drive/1bpY_77Ramzv3aNl1qb20da_QijbDIi_7
"""
...
def train_stage(df_path, lgb_path, xgb_path, cb_path):
    ...
    auc_mean = round(roc_auc_score(y_df, (lgb_cv_result+xgb_cv_result+cb_cv_result)/2), 4)
...
def prediction_stage(df_path, lgb_path, xgb_path, cb_path):
    ...
    submission = pd.read_csv('/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/data/sample_submission.csv')
    submission['target'] = (lgb_result+xgb_result+cb_result)/2
...
if __name__ == '__main__':
    ...
    train_path = '/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/data/train.csv'
    test_path  = '/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/data/test.csv'
    
    lgb_path = '/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/models/lgb_models_stack/'
    xgb_path = '/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/models/xgb_models_stack/'
    cb_path  = '/content/drive/My Drive/Coding_Exercise/Kaggle/Santander/models/cb_models_stack/'
